...
module.exports = {
    ...
    run: async (client, message, args, args1) => {
        await reply(message, await createAuthorEmbed(`Deployment version: ${await client.getDeployment(client.arguments)}`, process.env.VALORIAN_MAIN_EMBED_COLOUR, message.author))
    }
}